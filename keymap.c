...
// Mod-tap
#define MT_LSFT MT(MOD_LSFT, KC_LEFT_CURLY_BRACE)
#define MT_RSFT MT(MOD_RSFT, KC_RIGHT_CURLY_BRACE)
...
[_QWERTY] = LAYOUT_preonic_grid(
    ...
    MICMUTE, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
